...
?>
                            ...
                            <article class="group bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col transform hover:-translate-y-2 opacity-0 animate-scale-in animate-on-scroll">
                                ...
                                <div class="p-6 flex flex-col flex-grow">
                                    ...
                                    <div class="flex justify-between items-center mt-auto">
                                        ...
                                        <!-- Order Button -->
                                        <button class="bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-white font-medium py-2 px-6 rounded-full transition-all duration-300 transform hover:scale-105">
                                            Pesan
                                        </button>
                                    </div>
                                </div>
    ...
    <div class="fixed bottom-8 right-8 z-50 opacity-0 animate-fade-in-up animate-on-scroll" style="animation-delay: 300ms">
        <button class="bg-red-600 hover:bg-red-700 text-white w-14 h-14 rounded-full shadow-xl flex items-center justify-center transition-all duration-300 transform hover:scale-110">
